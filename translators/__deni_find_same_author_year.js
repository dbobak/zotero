{
"translatorID":"04623cf0-194c-71df-5eac-5292753d7c29",
"translatorType":2,
"label":"__deni find same author-year",
"creator":"Darek Bobak",
"target":"xml",
"minVersion":"1.0",
"maxVersion":"",
...
"lastUpdated":"2014-03-09 12:00:00"
}
...
function getItemID() {
	var itemID = "";
	itemID = item.extra.substring(item.extra.lastIndexOf("bibtex: "),item.extra.lastIndexOf("\n"));
	itemID = itemID.substr(8);
//	itemID = "kapusta";
	return itemID;
}
...
function getAttachmentString() {
	if(item.attachments) {
		...
		var attachment = item.attachments[i];
			...
			attachmentString="* [" + attachmentString + " " + attachment.title + "]\n";
...
// podstrona z przekierowaniem
		...
		Zotero.write(Zotero.Utilities.htmlSpecialChars(shorttopicname)+ "\r\n");
		first = false;
	}
//	Zotero.write("\r\n</mediawiki>");
}
