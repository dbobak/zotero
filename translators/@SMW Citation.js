{
	"translatorID": "a515a220-6fef-0111-1974-8025dfebcc8f",
	"label": "@SMW Citation",
	...
	"inRepository": false,
	"lastUpdated": "2018-11-12 11:03:52"
}
...
var Translator = {
  ...
  header: {"translatorID":"a515a220-6fef-0111-1974-8025dfebcc8f","label":"@SMW Citation","description":"exports citations to be copy-pasted do Semantic Cite","creator":"Emiliano Heyns, Dariusz Bobak","target":"txt","minVersion":"4.0.27","translatorType":2,"browserSupport":"gcsv","priority":100,"displayOptions":{"quickCopyMode":""},"inRepository":false,"lastUpdated":"2018-11-12 11:03:52"},
...
const Mode = {
    ...
    pandoc(items) {
        let keys = items.map(item => `[[CiteRef::@${item.citekey}]]`);
        keys = keys.join(', ');
