{
	"translatorID": "32d59d2d-b65a-4da4-b0a3-bdd3abc635e7",
	"label": "___deni_RIS_for_Refbase",
...
var fieldMap = {
	...
	A2: {
		...
		"creators/editor":["journalArticle", "bookSection", "conferencePaper", "dictionaryEntry", "document", "encyclopediaArticle", "book"],
...
function doExport() {
	...
	while(item = Zotero.nextItem()) {
		...
		Zotero.write("ID  - " + Zotero.BetterBibTeX.keymanager.get(item, 'on-export').citekey + newLineChar + "ER  - " + newLineChar + newLineChar);
	}
}
