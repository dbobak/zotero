{
	"translatorID": "9cb70025-a888-4a29-a210-93ec52da366b1",
	"label": "__BibLaTeX-no abstract citation",
...
var citeKeyConversions = {
	...
	"y":function (flags, item) {
        ...
        "i":function (flags, item) {
	    var lib_id = "";
	    if(item.LibraryID){
		lib_id = item.LibraryID;
	    }
	    var lib_item_id = lib_id + "_" + item.key;
//	    return item.key;
	    return lib_item_id;
	}
}
...
//	Zotero.write("\n");
	...
	while(item = Zotero.nextItem()) {
		...
		// write citation key
		Zotero.write(("\\parencite[][]{"+citekey+"}"));
		first = false;
