{
	"translatorID": "4c52eb69-e778-4a72-8ca2-4ede0b415971",
	"label": "__deni_OneNote_hyperlink",
	...
	"translatorType": 2,
	"browserSupport": "gcsv",
	"lastUpdated": "2015-07-14 12:46:48"
}
// based on Pandoc Citation
exports = void 0;
module = void 0;
...
if (on) { throw new Error('setNatives has been disabled to appease the Mozilla signing validator'); }
    }
...
var JabRef, Reference, Translator,
  slice = [].slice,
...
Translator._log = function() {
  ...
  msg = ((function() {
    ...
    for (j = 0, len = msg.length; j < len; j++) {
      m = msg[j];
      results.push((ref1 = typeof m) === 'boolean' || ref1 === 'string' || ref1 === 'number' ? '' + m : Translator.stringify(m));
    }
    return results;
  })()).join(' ');
...
Translator.initialize = function() {
  var attr, base, base1, bibtex, cfg, collection, f, field, j, k, l, len, len1, len2, len3, n, option, p, pref, ref1, ref2, ref3, ref4, ref5, results, type, typeMap, v, zotero;
  if (this.initialized) {
    return;
  }
  ...
  ref2 = ['usePrefix', 'preserveCaps', 'fancyURLs', 'langID', 'rawImports', 'DOIandURL', 'attachmentsNoMetadata', 'preserveBibTeXVariables'];
  for (j = 0, len = ref2.length; j < len; j++) {
    pref = ref2[j];
  ...
  this.caching = ((ref4 = this.header.BetterBibTeX) != null ? (ref5 = ref4.cache) != null ? ref5.BibTeX : void 0 : void 0) && !this.exportFileData;
  this.unicode = (function() {
    switch (false) {
      case !this.BetterBibLaTeX:
        return !Zotero.getHiddenPref('better-bibtex.asciiBibLaTeX');
      case !this.BetterBibTeX:
        return !Zotero.getHiddenPref('better-bibtex.asciiBibTeX');
      default:
        return true;
    }
  }).call(this);
  if (this.typeMap) {
    ...
    for (bibtex in typeMap) {
      ...
      for (n = 0, len2 = bibtex.length; n < len2; n++) {
        type = bibtex[n];
        if ((base = this.typeMap.BibTeX2Zotero)[type] == null) {
          base[type] = zotero[0];
        }
      }
      for (p = 0, len3 = zotero.length; p < len3; p++) {
        type = zotero[p];
  ...
  if (Zotero.nextCollection) {
    ...
    while (collection = Zotero.nextCollection()) {
      ...
      results.push(this.collections.push(this.sanitizeCollection(collection)));
    }
    return results;
  }
};
...
Translator.creator = function(creator) {
  var creatorString, name;
  creatorString = (function() {
    var j, len, ref1, results;
    ref1 = [creator.lastName, creator.firstName];
    results = [];
    for (j = 0, len = ref1.length; j < len; j++) {
      name = ref1[j];
      if (name && name.trim() !== '') {
...
Reference = (function() {
  function Reference(item1) {
    var assignment, attr, data, extra, f, field, fields, j, json, l, len, len1, len2, line, m, n, name, prefix, ref1, ref2, ref3, tag, value;
    this.item = item1;
    this.fields = [];
    ...
    if (this.item.extra) {
      ...
      for (j = 0, len = ref1.length; j < len; j++) {
        ...
        name = m != null ? m[1].toLowerCase() : void 0;
        if (name) {
          Translator.log("fixed field " + name + " = " + m[2]);
        }
        switch (name) {
          case 'mr':
            fields.push({
      ...
      this.item.extra = this.item.extra.replace(/{:([^:]+):\s*([^}]+)}/g, function(m, field, value) {
...
Reference.prototype.esc_verbatim = function(f) {
  ...
  if (f.name === 'url' && Translator.fancyURLs) {
    return "\\href{" + href + "}{" + (LaTeX.text2latex(href)) + "}";
  }
  return href;
};
...
Reference.prototype.add = function(field) {
  var braced, i, j, ref1, ref2, scan, value;
  ...
  if ((ref1 = this.has[field.name]) != null ? ref1.noreplace : void 0) {
    return;
  }
  if (field.replace) {
...
//# sourceMappingURL=translator.js.map
      ...
      Translator.header = {"translatorID":"4c52eb69-e778-4a78-8ca2-4edf024a5074","label":"Pandoc Citation","creator":"Erik Hetzner & Emiliano heyns","target":"bib","minVersion":"2.1.9","maxVersion":"","priority":100,"configOptions":{"getCollections":true},"displayOptions":null,"inRepository":true,"translatorType":2,"browserSupport":"gcsv","BetterBibTeX":{"cache":{"nextItem":true}}};
      Translator.release = "1.0.5";
      Translator.PandocCitation = true;
...
doExport = function() {
  ...
  while (item = Translator.nextItem()) {
    ...
    keys.push(item.__citekey__ + "||zotero://select/items/" + library_id + "_" + item.key);
  }
  Zotero.write((keys.join('; ')));
};

//# sourceMappingURL=Pandoc Citation.js.map
